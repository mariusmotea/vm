...
. <(curl -sL https://raw.githubusercontent.com/mariusmotea/vm/master/lib.sh)
...
true
# shellcheck source=lib.sh
FIRST_IFACE=1 && CHECK_CURRENT_REPO=1 . <(curl -sL https://raw.githubusercontent.com/mariusmotea/vm/master/lib.sh)
unset FIRST_IFACE
